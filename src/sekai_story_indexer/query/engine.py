...
if TYPE_CHECKING:
    ...
    from sekai_story_indexer.query.audit import AnswerAuditor
...
class StoryQueryEngine:
    ...
    def _audit_stage(
        ...
        from sekai_story_indexer.query.audit import AuditReport, build_audit_payload
    ...
    def _append_audit(
        ...
        if not self._config().audit_enabled or not answer_text:
            return answer_text
        from sekai_story_indexer.query.audit import AuditReport, render_audit_flags
