...
def test_build_lyric_page_map_joins_on_song_id():
    cargo_rows = [
        {"song_id": 1, "pageid": 432, "title": "Tell Your World"},
        {"song_id": 64, "pageid": 1289, "title": "Stella"},
        {"song_id": 999, "pageid": 5000, "title": "Wiki-only Song"},  # not in master DB
    ]
    result = build_lyric_page_map(cargo_rows, known_music_ids={1, 64, 77})
    assert result["mapping"] == {
        1: {"pageid": 432, "title": "Tell Your World"},
        64: {"pageid": 1289, "title": "Stella"},
    }
...
def test_build_lyric_page_map_ignores_bad_rows_and_dupes():
    rows = [
        {"song_id": 5, "pageid": 10, "title": "First"},
    ...
    assert result["mapping"] == {5: {"pageid": 10, "title": "First"}}
...
def test_sekaipedia_song_pages_paginates_and_normalizes(monkeypatch):
    ...
    pages = {
        0: [{"title": {"song_id": "1", "pageid": "432", "title": "Tell Your World"}},
            {"title": {"song_id": "x", "pageid": "9", "title": "junk"}}],  # dropped
        2: [{"title": {"song_id": "64", "pageid": "1289", "title": "Stella"}},
            {"title": {"song_id": "65", "pageid": "1290", "title": "Next"}}],
        4: [],
    }
    ...
    assert rows == [
        {"song_id": 1, "pageid": 432, "title": "Tell Your World"},
        {"song_id": 64, "pageid": 1289, "title": "Stella"},
        {"song_id": 65, "pageid": 1290, "title": "Next"},
    ]
